...
import { articlesHandler, currentSeasonHandler, kitsHandler, plansHandler } from './catalog.controller.js';
...
catalogRouter.get('/current-season', asyncHandler(currentSeasonHandler));
catalogRouter.get('/season', asyncHandler(currentSeasonHandler));
